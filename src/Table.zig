...
pub const TableError = error{ KeyColumnMissing, ColumnMissing, DefinitionMissing, ColumnNotFind, ColumnValueMissing, PrimaryKeyValueMissing, TableAlreadyExit, IndexesValueMissing };
...
pub const Record = struct {
    ...
    fn decodeVal(self: *Record, in: []const u8, idx: u16, pos: *u16) !void {
    ...
    fn encodeVal(self: *Record, idx: u16, list: *std.ArrayList(u8)) !void {
        switch (self.def.Types[idx]) {
