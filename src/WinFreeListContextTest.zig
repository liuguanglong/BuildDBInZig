...
const wincontextwithfreelist = @import("WinFreeListContext.zig");
...
test "open test" {
    ...
    var context = try kvcontext.createWindowsFreeListContext(allocator, filename, 20);
    ...
    //try std.testing.expectEqual(std.mem.eql(u8, nodeA.data, pNode.data), true);
